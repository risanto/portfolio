...
function SectionHeading({
  ...
  return (
    <div className="mb-6">
      ...
      <h2 className="mt-1 font-mono text-xl sm:text-2xl font-medium text-ink">
        {title}
      </h2>
    </div>
  );
...
export default function Home() {
  return (
    <main className="mx-auto max-w-3xl px-4 sm:px-6">
      ...
      <footer
        id="contact"
        className="border-t border-line py-10 sm:py-14 mb-6"
      >
        <p className="font-mono text-xs text-ink-soft">$ echo $CONTACT</p>
        <p className="mt-1 max-w-xl text-lg text-ink">
          Open to conversations about full stack or iOS roles. Reach out
          below.
        </p>
        <div className="mt-5">
          <SocialLinks />
